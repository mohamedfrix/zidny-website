...
import OffreLand from '@/assets/images/Form/OffreLand.jpg'
import OffreLand_mob from '@/assets/images/Form/OffreLand_Mob.jpg'
import arrow from '@/assets/images/arrow.svg'
import Image from "next/image";
import { useState, useEffect } from "react";
import Progress from "@/components/form/Progress";
import step_2_landing from "@/components/form/Step_2_landing"
import Step_5 from "@/components/form/Step_5"
import Step_Offers_landing from "@/components/form/Step_Offers_landing";
...
const steps = [ step_2_landing, Step_Offers_landing ,Step_5];

function DevisLanding() {
            ...
            <section className="min-h-screen flex justify-center items-center p-4 sm:p-6 bg-gray-50">
                ...
                <div className="relative w-full max-w-6xl min-h-[700px] bg-white rounded-3xl overflow-hidden shadow-2xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 h-full">
                        ...
                        <div className="relative h-80 sm:h-80 md:h-full w-full order-1 md:order-2 ">
                            <Image
                                ...
                                priority
                                className={`object-cover object-center transition-opacity duration-500 ease-in-out ${isMobile ? '' : 'scale-105'} `}
                            />
