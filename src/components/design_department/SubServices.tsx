...
>
  <div className="flex flex-col gap-2">
    ...
    {/* Version corrigée de l'ul avec espacement fixe */}
    <div className={`transition-all duration-700 ease-in-out delay-100 ${
      hoveredIndex === index ? 'opacity-100 max-h-40' : 'opacity-0 max-h-0'
    }`}>
      <ul className={`mt-4 pl-5 list-disc text-[#9FA2A7] font-medium text-[14px] sm:text-[15px] lg:text-[16px] font-outfit space-y-1 ${
